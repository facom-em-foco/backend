...
export class InitialMigration1728486171950 implements MigrationInterface {
    name = 'InitialMigration1728486171950'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "date_info" ("id" SERIAL NOT NULL, "postDate" TIMESTAMP NOT NULL DEFAULT now(), "expireDate" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "modifiedAt" TIMESTAMP NOT NULL DEFAULT now(), "postId" integer, CONSTRAINT "REL_72d4ac887f39b133e8f69dd17c" UNIQUE ("postId"), CONSTRAINT "PK_4a4a19230d36b4721f88fa2d9f3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "post" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "link" character varying, "imagePath" character varying, "textContent" text, "publisherId" integer, CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "date_info" ADD CONSTRAINT "FK_72d4ac887f39b133e8f69dd17cf" FOREIGN KEY ("postId") REFERENCES "post"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
